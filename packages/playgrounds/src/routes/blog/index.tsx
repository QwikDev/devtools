  ...
  return (
    <div class="page-content">
      <section class="page-hero glass-frame">
        ...
        <p class="hero-lead">
          List-detail flows are part of the demo too. The notes section gives the playground a
          more realistic content rhythm while staying completely local.
        </p>
      </section>
      ...
      <section class="section-card">
        <div class="section-heading">
          ...
          <h2>Mock content with enough structure to test layout depth, metadata, and navigation.</h2>
        </div>
