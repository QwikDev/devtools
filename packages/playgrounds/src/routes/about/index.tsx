    ...
    <div class="page-content">
      <section class="page-hero glass-frame">
        ...
        <p class="hero-lead">
          ...
          miniature product surface. That makes route transitions, async states, and state
          graphs easier to reason about during demos and while using devtools.
        </p>
      </section>
          ...
          <div class="inspection-list">
            <div class="inspection-row">
              ...
              <div>
                ...
                <p>Move between the command center, notes list, and detail route to watch location updates.</p>
              </div>
            </div>
            <div class="inspection-row">
              ...
              <div>
                ...
                <p>Use the async panel to toggle pending, empty, and error without wiring a backend.</p>
              </div>
            </div>
            <div class="inspection-row">
              ...
              <div>
                ...
                <p>Check how signals and derived metrics are grouped into readable cards instead of raw dumps.</p>
              </div>
            </div>
          </div>
        </div>
