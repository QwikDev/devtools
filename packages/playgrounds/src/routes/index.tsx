...
import {
  ...
  homeMetrics,
  quickJumpCards,
} from '~/content/playground-content';
...
const featureGlyphs: Record<
  string,
  'route' | 'stack' | 'pulse' | 'spark' | 'notes'
> = {
  routing: 'route',
  resumability: 'stack',
  resources: 'pulse',
    ...
    <div class="page-content">
      <section class="hero-layout section-card">
        <div class="hero-copy glass-frame">
          ...
          <p class="hero-lead">
            This playground now behaves like a compact showcase site: atmospheric enough for
            demos, structured enough for routing checks, and alive enough for devtools
            inspection.
          </p>
      ...
      <section class="section-card">
        <div class="section-heading">
          ...
          <h2>Modern playgrounds are easier to trust when they make state, routes, and variation observable.</h2>
        </div>

        <div class="feature-grid">
          {featureCards.map((feature) => (
            <article
              class={`capability-card capability-card--${feature.accent}`}
              key={feature.id}
            >
      ...
      <section class="section-card">
        <div class="section-heading">
          ...
          <h2>One shared panel for controls, async transitions, environment context, and route-aware events.</h2>
        </div>
      ...
      <section class="section-card">
        <div class="section-heading">
          ...
          <h2>Use the surrounding routes as part of the demo surface, not as leftover boilerplate.</h2>
        </div>
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: 'description',
      content: 'A richer Qwik playground with route demos, async experiments, and a glass-panel visual system.',
    },
  ],
};
