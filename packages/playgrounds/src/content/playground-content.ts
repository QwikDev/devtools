...
export const featureCards: FeatureCard[] = [
  ...
  },
  {
    ...
    description:
      'The interface exposes Qwik state without turning the page into a debugger dump.',
  ...
  },
  {
    ...
    description:
      'Preset buttons, scenario switches, and resets give the demo a repeatable rhythm.',
...
export const aboutPrinciples = [
  {
    ...
    body:
      'Each route demonstrates a different information mode: overview, rules, list, and long-form detail. This makes the demo useful for routing checks instead of only screenshot polish.',
  },
  {
    title: 'State needs narrative, not raw dumps.',
    body:
      'Signals, derived values, resource lifecycle, and navigation state are grouped into compact cards so the UI reads like a system console instead of a debug transcript.',
  },
  {
    title: 'Async behavior deserves deliberate stagecraft.',
    body:
      'Latency presets and scenario controls let people see pending, empty, and failure modes without wiring a real backend.',
  },
  {
    title: 'Design language should echo the tool it supports.',
    body:
      'The palette borrows from the devtools package, but the playground adds its own darker, more atmospheric shell so the app feels intentional rather than copied.',
  },
] as const;
...
export const quickJumpCards = [
  {
    ...
    description:
      'See the system rules, visual grammar, and why each route exists in the demo.',
  },
  {
    href: '/blog',
    title: 'Browse lab notes',
    description:
      'Open mock experiments with tags, reading time, and one nested article route.',
  },
  {
...
await new Promise((resolve) => {
  ...
  },
  {
    ...
    summary: 'A tiny route tree can still feel like a product if each page carries a different informational role.',
    excerpt:
  ...
  },
  {
    ...
    summary: 'A note on using translucent layers without turning the whole UI into a blur experiment.',
    excerpt:
