...
export function findAllComponentBodyRangesFromProgram(
  program: unknown,
): ComponentBodyRange[] {
...
function getComponentBodyRange(
  node: any,
  parent: any,
): ComponentBodyRange | null {
...
function getComponentFunctionBody(
  node: any,
  ...
  return componentFactory.body?.type === 'BlockStatement'
    ? componentFactory.body
    : null;
}
