    ...
    <div class="bg-card border-border/50 hover:border-primary/30 hover:shadow-primary/5 group relative rounded-xl border p-5 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
      ...
      <div class="relative flex flex-col gap-4">
        ...
        <div class="flex items-start gap-4">
          {/* Package Avatar */}
          <div
            class="from-primary/10 via-primary/20 to-primary/30 border-primary/20 group-hover:shadow-primary/20 flex h-12 w-12 flex-shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-xl border bg-gradient-to-br shadow-md transition-all duration-300 hover:rotate-3 hover:scale-110"
