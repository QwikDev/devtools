    ...
    <div class="space-y-4">
      <div class="relative">
        <input
          ...
          class="w-full rounded-lg border border-border bg-foreground/5 px-4 py-2 text-sm text-foreground placeholder-muted-foreground outline-none focus:border-border"
        />
      </div>
