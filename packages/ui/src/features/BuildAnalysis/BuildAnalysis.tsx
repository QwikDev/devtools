...
export const BuildAnalysis = component$(() => {
  ...
  return (
    <div class="flex h-full min-h-0 flex-col gap-4">
      <div class="rounded-2xl border border-glass-border bg-card-item-bg p-5">
        <div class="flex flex-col gap-3">
          <div class="text-lg font-semibold">Build Analysis</div>
          <div class="text-muted-foreground max-w-3xl text-sm leading-6">
            This tab embeds the HTML report generated by the visualizer plugin
            after a build.
          </div>
          {buildCommand.value ? (
      ...
      {isChecking.value ? (
        <div class="rounded-2xl border border-glass-border bg-card-item-bg p-6 text-sm text-muted-foreground">
        ...
        <>
          ...
          <div class="min-h-0 flex-1 overflow-hidden rounded-2xl border border-glass-border bg-card-item-bg">
            <iframe
        ...
        <div class="rounded-2xl border border-glass-border bg-card-item-bg p-6">
