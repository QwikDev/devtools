...
[Choose an issue template](https://github.com/QwikDev/devtools/issues/new/choose) to file a bug report / feature request.
...
### ▶ 1. First - [Search this repo for existing PRs](https://github.com/QwikDev/devtools/pulls) !

Try to find an open or closed PR that relates to the change you want to introduce.

<br/>

### ▶ 2. **Before you start coding - [find](https://github.com/QwikDev/devtools/issues) / [create an issue](https://github.com/QwikDev/devtools/issues/new/choose)**
...
In GitHub, create a pull request for `QwikDev/devtools:main`.
